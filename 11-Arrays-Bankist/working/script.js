...
//     .concat(dogsKate)
//     .forEach((age, i) =>
//       console.log(`Dog ${i + 1} is a ${age < 3 ? "puppy" : "adult"}`)
//     );
// }
//
...
// }
//
// console.log(calcAverageHumanAge(td1));
...
if (dogSarah.curFood > dogSarah.recommendedFood * 1.1) {
  ...
  resultStr = "too little";
} else {
  resultStr = "enough";
}

console.log(`Sarah's dog is eating ${resultStr}`);
...
console.log(dogs.some(isEatingOk));

// Task #7

const healthyDogs = dogs.filter(isEatingOk);
